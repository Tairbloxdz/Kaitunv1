...
--[[ Bắt đầu tích hợp giao diện Trash Hub V2 ]]--
...
-- Labels (placeholders to update later)
...
local function updateAccountInfo()
    while task.wait(1) do -- Check every second
        -- Update Info Section
        WorldLabel:UpdateLabel("World: " .. tostring(game.Players.LocalPlayer.World or "N/A"))
        NameLabel:UpdateLabel("Name: " .. tostring(game.Players.LocalPlayer.Name or "N/A"))
        LevelLabel:UpdateLabel("Level: " .. tostring(game.Players.LocalPlayer.Level or "N/A"))
        FragmentsLabel:UpdateLabel("Fragments: " .. tostring(game.Players.LocalPlayer.Fragments or "0"))
        RaceLabel:UpdateLabel("Race: " .. tostring(game.Players.LocalPlayer.Race or "N/A"))
        EvoRaceLabel:UpdateLabel("Evo Race: " .. tostring(game.Players.LocalPlayer.EvoRace or "N/A"))
        FruitLabel:UpdateLabel("Fruit: " .. tostring(game.Players.LocalPlayer.Fruit or "N/A"))
        FruitMasLabel:UpdateLabel("Fruit Mas: " .. tostring(game.Players.LocalPlayer.FruitMas or "N/A"))
        AwakenLabel:UpdateLabel("Awaken: " .. (game.Players.LocalPlayer.Awaken and "✔" or "✖"))

        -- Update Fighting Status
        FightingLabels.Godhuman:UpdateLabel("Godhuman: " .. (game.Players.LocalPlayer.Fighting.Godhuman and "✔" or "✖"))
        FightingLabels.Superhuman:UpdateLabel("Superhuman: " .. (game.Players.LocalPlayer.Fighting.Superhuman and "✔" or "✖"))
        FightingLabels.SharkmanKarate:UpdateLabel("SharkmanKarate: " .. (game.Players.LocalPlayer.Fighting.SharkmanKarate and "✔" or "✖"))
        FightingLabels.DragonTalon:UpdateLabel("DragonTalon: " .. (game.Players.LocalPlayer.Fighting.DragonTalon and "✔" or "✖"))
        FightingLabels.ElectricClaw:UpdateLabel("ElectricClaw: " .. (game.Players.LocalPlayer.Fighting.ElectricClaw and "✔" or "✖"))
        FightingLabels.DeathStep:UpdateLabel("DeathStep: " .. (game.Players.LocalPlayer.Fighting.DeathStep and "✔" or "✖"))

        -- Update Sword Status
        SwordLabels.PoleV1:UpdateLabel("Pole V1: " .. (game.Players.LocalPlayer.Swords.PoleV1 and "✔" or "✖"))
        SwordLabels.PoleV2:UpdateLabel("Pole V2: " .. (game.Players.LocalPlayer.Swords.PoleV2 and "✔" or "✖"))
        SwordLabels.Rengoku:UpdateLabel("Rengoku: " .. (game.Players.LocalPlayer.Swords.Rengoku and "✔" or "✖"))
        SwordLabels.Shisui:UpdateLabel("Shisui: " .. (game.Players.LocalPlayer.Swords.Shisui and "✔" or "✖"))
        SwordLabels.Saddi:UpdateLabel("Saddi: " .. (game.Players.LocalPlayer.Swords.Saddi and "✔" or "✖"))
        SwordLabels.Wando:UpdateLabel("Wando: " .. (game.Players.LocalPlayer.Swords.Wando and "✔" or "✖"))
        SwordLabels.TrueTripleKatana:UpdateLabel("True Triple Katana: " .. (game.Players.LocalPlayer.Swords.TrueTripleKatana and "✔" or "✖"))

        -- Update Accessory Status
        AccessoryLabel:UpdateLabel("Accessory: " .. tostring(game.Players.LocalPlayer.Accessory or "None"))
    end
end
